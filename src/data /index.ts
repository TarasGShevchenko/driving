...
export const cards: Card[] = [
  {
    ...
    sale: '28 000 грн',
    description: [
      'Теоретичний курс навчання на платформі Zoom - 3000 грн',
      'Практичний курс навчання ( 40 занять з водіння ) - 25000 грн',
      'Паливо (ПММ)',
      'Література (ПДР)',
      'Внесок від 6000 грн.',
  ...
  },
  {
    ...
    sale: '28 000 грн',
    description: [
      'Теоретичний курс навчання в класі - 3000 грн',
      'Практичний курс навчання ( 40 занять з водіння ) - 25000 грн',
      'Паливо (ПММ)',
      'Література (ПДР)',
      'Внесок від 6000 грн.',
  ...
  },
  {
    ...
    sale: '4 000 грн',
    description: [
      'Повний курс теорії в класі або в Zoom - 4000 грн',
      'Література (ПДР)',
      'Внесок від 4000 грн.',
      // 'Медична довiдка водiя.',
      '',
  ...
  },
  {
    ...
    sale: '700 грн',
    description: [
      'Одне практичне заняття (тривалістю 60 хв) - 700 грн',
      'Паливо (ПММ)',
      // 'Внесок від 5000 грн.',
      // 'Медична довiдка водiя.',
      '',
